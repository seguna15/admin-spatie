    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <div class="flex  p-2">
                    <a href="{{  route('admin.roles.index') }}" class="px-4 py-2 bg-green-700 text-slate-100 hover:bg-green-500 rounded-md ">Back</a>
                </div>
                    ...
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                        <form method="POST" action="{{ route('admin.roles.update', $role->id) }}">
                            ...
                            <div class="sm:col-span-6">
                                <label for="title" class="block text-sm font-medium text-gray-700"> Role Name </label>
                                <div class="mt-1">
                                    <input type="text" 
                                    id="name" 
                                    name="name" 
                            ...
                            <div class="sm:col-span-6 pt-5">
                                <button type="submit" class="px-4 py-2 text-slate-100 bg-green-700 hover:bg-green-500 rounded-md">Edit</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="mt-6 p-2 bg-slate-100">
                    ...
                    <div class="max-w-xl mt-6">
                        <form method="POST" action="{{ route('admin.roles.permissions', $role->id) }}">
                            ...
                            <div class="sm:col-span-6 pt-5">
                                <button type="submit" class="px-4 py-2 text-slate-100 bg-green-700 hover:bg-green-500 rounded-md">Assign Permission</button>
                            </div>
                        </form>
                    </div>
                </div>
