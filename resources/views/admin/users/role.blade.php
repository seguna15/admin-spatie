    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <div class="flex  p-2">
                    <a href="{{  route('admin.users.index') }}" class="px-4 py-2 bg-green-700 text-slate-100 hover:bg-green-500 rounded-md ">Back</a>
                </div>
                    ...
                    <div class="max-w-xl mt-6">
                        <form method="POST" action="{{ route('admin.users.roles', $user->id) }}">
                            ...
                            <div class="sm:col-span-6 pt-5">
                                <button type="submit" class="px-4 py-2 text-slate-100 bg-green-700 hover:bg-green-500 rounded-md">Assign Role</button>
                            </div>
                        </form>
                    </div>
                </div>
